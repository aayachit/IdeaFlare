...
<?php include 'includes/profile-new-personal.inc.php'; ?>
		...
		<div class="col-sm-6">
			...
			<form method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="email" class="form-control" name="cp-altEmail" placeholder="abc@example.com">
				</div>
				<div class="row">
					<div class="form-group col-md-6">
						<label for="contact">Contact No:</label>
						<input type="number" class="form-control" name="cp-contact" placeholder="Mobile No">		<!-- check -->
					</div>
					<div class="form-group col-md-6">
						<label for="industry">Industry:</label>
						<input type="text" class="form-control" name="cp-industry" placeholder="Industry">
					</div>
				</div>
				<div class="form-group">
						<label for="summary">About you:</label>
    					<textarea class="form-control" rows="3" name="cp-about-you" placeholder="max 200 characters"></textarea>
				</div>
				<div class="form-group">
						<label for="cv">Upload CV(PDF):</label>
					    <input type="file" name="cp-cv" accept=".pdf" class="form-control form-input Profile-input-file">
				</div>
				<div class="form-group">
						<label for="profile-picture">Upload Profile Picture:</label>
					    <input type="file" name="cp-pp" accept="image/*" class="form-control form-input Profile-input-file" >
				</div>				
		        <div class="text-right mb-5"> 
		          <button type="submit" name="next" class="btn btn-primary btn-md">Next</button>
		        </div>
			</form>
		</div>
		<div class="col-sm-3"></div>
