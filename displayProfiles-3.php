...
<div class="container">
  ...
  <div class="row">
    ...
    echo'    <a href="displayProfiles-2.php?id='.$id.'" class="btn btn-danger button btn-md">Back</a>';
    echo'</div>';
    ?>

    <div class="mb-5 text-right col-md-6"> 
        <a href="displayProfiles.php" class="btn btn-primary button btn-md">Profiles</a>
    </div>
  </div>
