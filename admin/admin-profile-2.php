...
<div class="container">
  ...
  echo'      <a href="admin-profile-1.php?id='.$id.'" class="btn btn-danger btn-md">Back</a>';
  echo'  </div>';

  echo'  <div class="col-6 text-right mb-5"> ';
  echo'      <a href="admin-profile-3.php?id='.$id.'" class="btn btn-primary button btn-md">Next</a>';
  echo'  </div>';
  echo'</div>';
