...
<!-- PERSONAL INFORMATION -->
	...
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-personal.php" role="button">Edit</a>';
  	</div>
...
<!-- EDUCATION INFORMATION -->
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    ?>
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-education.php" role="button">Edit</a>';
  	</div>
	</div>
...
<!-- PROJECTS -->
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_projects SET project_id = $i WHERE id=$id and title = '". $row2['title'] ."'";
	    ...
	    if (mysqli_num_rows($result2)!=0) {
			...
			while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
				...
				echo '	</div>';
				echo '	<div class="col-md-6">';
				echo' 		<a href="profile-edit-addReport.php?project_id='.$row['project_id'].'">Update Project Report</a>';
				echo '	</div>';
				echo '</div>';
				...
				echo '<div class="row">';
				echo '	<div class="col-md-12">';
				echo' 		<a href="profile-edit-addReport.php?project_id='.$row['project_id'].'">Add Project Report</a>';
				echo '	</div>';
				echo '</div>';
				}
	    ...
	    ?>
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-projects.php" role="button">Edit</a>';
  	</div>
	</div>
...
<!-- EXPERIENCE INFORMATION -->
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    $i = 1;
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_experience SET experience_id = $i WHERE id=$id and company = '". $row2['company'] ."'";
	...
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-experience.php" role="button">Edit</a>';
  	</div>

	</div>

	<div class="text-right mb-5"> 
	    <a href="profile-2.php" class="btn btn-primary button btn-md">Next</a>
	</div>
