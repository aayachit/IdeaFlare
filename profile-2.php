...
<div class="container">
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_skills SET skill_id = $i WHERE id=$id and name = '". $row2['name'] ."'";
	...
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-skills.php" role="button">Edit</a>';
  	</div>
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    $i = 1;
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_certifications SET certification_id = $i WHERE id=$id and number = '". $row2['number'] ."'";
	    ...
	    ?>
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-certifications.php" role="button">Edit</a>';
  	</div>
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    $i = 1;
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_courses SET course_id = $i WHERE id=$id and number = '". $row2['number'] ."'";
	    ...
	    ?>
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-courses.php" role="button">Edit</a>';
  	</div>
	...
	<div class="jumbotron pt-3 mt-4">
	    ...
	    $i = 1;
	    while($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)) {
	      $sql3 = "UPDATE cp_workshops SET workshop_id = $i WHERE id=$id and name = '". $row2['name'] ."'";
	...
	<div class="text-right"> 
       <a class="btn btn-primary btn-md" href="profile-edit-workshops.php" role="button">Edit</a>';
  	</div>
	...
	<div class="row">
		<div class="col-6 mb-5"> 	
		    <a href="profile-1.php" class="btn btn-danger btn-md">Back</a>
		</div>
...
<!-- <div class="container">
	...
	<div class="jumbotron pt-3 mt-4">
		...
		<div class="row">
			<div class="col-md-12">
				<p class="font-weight-bold">Certification# 1</p>
			</div>	
		</div>	
	...
	<div class="jumbotron pt-3 mt-4">
		...
		<div class="row">
			<div class="col-md-12">
				<p class="font-weight-bold">Course# 1</p>
			</div>	
		</div>	
	...
	<div class="jumbotron pt-3 mt-4">
		...
		<div class="row">
			<div class="col-md-12">
				<p class="font-weight-bold">Workshop# 1</p>
			</div>	
		</div>	
