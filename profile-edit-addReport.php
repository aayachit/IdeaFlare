...
<?php include 'includes/profile-edit-addReport.inc.php'; ?>
...
<div class="container-fluid add-info">
	<div class="row">
		...
		<div class="col-sm-6">
			<h3 class="text-center mt-5">Project Report</h3>
			<form method="post" enctype="multipart/form-data">
				...
				echo '<input type="hidden" class="form-control" name="project_id" value="'.$project_id.'" required >';
